...
export default function MenuOverlay() {
  ...
  return (
    <div className={`menu-overlay${isOpen ? ' open' : ''}`} role={"dialog"} aria-modal id="menu" aria-label="Navigation">
      <button className="mcls" onClick={closeMenu} aria-label="Close menu" id="closeMenu">
