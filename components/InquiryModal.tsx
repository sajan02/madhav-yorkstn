...
export default function InquiryModal() {
  ...
  return (
    <div id="inq" role="dialog" aria-modal="true" aria-label="Brand enquiry" className={`inq-overlay${isOpen ? ' open' : ''}`} onClick={(e) => { if (e.target === e.currentTarget) closeInquiry(); }}>
      <div className="im">
        {/* Header */}
        <div className="ih">
          <button className="icls" onClick={closeInquiry} aria-label="Close" id="closeInq">×</button>
        ...
        <div className="ib">
          {!submitted ? (
            <form onSubmit={handleSubmit} noValidate id="inqForm">
              <div className="irow">
              ...
              <div className="irow">
                ...
                <div className="ifield">
                  ...
                  <select className="isel" id="fc2" value={form.category} onChange={e => set('category', e.target.value)}>
              ...
              <div className="irow">
                <div className="ifield">
                  ...
                  <select className="isel" id="fs" value={form.stage} onChange={e => set('stage', e.target.value)}>
              ...
              {error && <p className="ierr" id="ferr">{error}</p>}
              <div className="ifoot">
            ...
            <div className="iok show" id="inqOk">
